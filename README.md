...
2. VS Code 聚合任务： [/.vscode/tasks.json](../.vscode/tasks.json) 的 `automation-hub: k8s-host-flow` 和 [/.vscode/tasks.json](../.vscode/tasks.json) 的 `automation-hub: k8s-docker-flow`
